...
def upgrade():
    ...
    op.create_unique_constraint(op.f('users_full_name_key'), 'users', ['full_name'], schema='sampledb')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(op.f('users_full_name_key'), 'users', schema='sampledb', type_='unique')
